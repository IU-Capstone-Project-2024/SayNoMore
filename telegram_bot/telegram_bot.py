...
import threading
import json
from telegram import Update, InlineKeyboardMarkup, InlineKeyboardButton, LabeledPrice, InputMediaPhoto, WebAppInfo, KeyboardButton, ReplyKeyboardMarkup
...
from telegram_bot.utils.formatting import route_list_to_string, translate_to_russian, format_web_app_data
...
class SayNoMoreBot:
    ...
    async def launch_mini_app(self, chat_id):
        ...
        button = KeyboardButton(text="Open Trip Form", web_app=WebAppInfo(url=mini_app_url))
        keyboard = ReplyKeyboardMarkup([[button]], resize_keyboard=True, one_time_keyboard=True)
        await self.application.bot.send_message(chat_id, "Please fill out your trip details using the form below:",
