...
route_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../api_collector/route'))
...
def handle_user_request(message):
    ...
    if message.text == 'I want to leave Kazan on July 1st.' and not second:
        ...
        bot.send_message(message.chat.id, "All good, let me prepare a trip plans for you")
