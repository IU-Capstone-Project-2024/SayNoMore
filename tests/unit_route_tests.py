...
from api_collector.route.route_collector import RouteCollector


class TestRouteCollector(unittest.TestCase):

    @patch('api_collector.route.route_collector.AirTicketsApi'
           )  # Mock the AirTicketsApi class
    def test_get_ticket_with_budget(self, MockAirTicketsApi):
        ...
        mock_api_instance.fetch_cheapest_tickets.side_effect = [
            ...
            },
            {
                'success': True,
                'data': []
            }  # No more data on the second page
        ]

        collector = RouteCollector()

        # Call the method with a budget
        ticket = collector.get_ticket(origin='JFK',
                                      destination='LAX',
                                      departure_at='2024-07-01',
                                      return_at='2024-07-15',
                                      budget=200.0)
    ...
    @patch('api_collector.route.route_collector.HotelApi'
    ...
    def test_get_hotel_with_budget(self, MockHotelApi):
        ...
        # Call the method with a budget
        hotel = collector.get_hotel(location='Ryazan',
                                    check_in='2024-07-01',
    ...
    @patch('api_collector.route.route_collector.RouteCollector.get_ticket')
    @patch('api_collector.route.route_collector.RouteCollector.get_hotel')
    def test_find_top_routes_with_budget(self, mock_get_hotel,
                                         mock_get_ticket):
        ...
        # Call the method with a budget
        routes = collector.find_top_routes(origin='JFK',
                                           destination='LAX',
                                           departure_at='2024-07-01',
                                           return_at='2024-07-15',
                                           budget=300.0,
